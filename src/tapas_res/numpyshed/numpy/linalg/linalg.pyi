...
@overload
def eigh(a: _ArrayLikeInt_co, UPLO: L["L", "U", "l", "u"] = ...) -> tuple[NDArray[float64], NDArray[float64]]:
    ...

@overload
def eigh(a: _ArrayLikeFloat_co, UPLO: L["L", "U", "l", "u"] = ...) -> tuple[NDArray[floating[Any]], NDArray[floating[Any]]]:
    ...

@overload
def eigh(a: _ArrayLikeComplex_co, UPLO: L["L", "U", "l", "u"] = ...) -> tuple[NDArray[floating[Any]], NDArray[complexfloating[Any, Any]]]:
    ...

@overload
def svd(a: _ArrayLikeInt_co, full_matrices: bool = ..., compute_uv: L[True] = ..., hermitian: bool = ...) -> tuple[NDArray[float64], NDArray[float64], NDArray[float64],]:
    ...

@overload
def svd(a: _ArrayLikeFloat_co, full_matrices: bool = ..., compute_uv: L[True] = ..., hermitian: bool = ...) -> tuple[NDArray[floating[Any]], NDArray[floating[Any]], NDArray[floating[Any]],]:
    ...

@overload
def svd(a: _ArrayLikeComplex_co, full_matrices: bool = ..., compute_uv: L[True] = ..., hermitian: bool = ...) -> tuple[NDArray[complexfloating[Any, Any]], NDArray[floating[Any]], NDArray[complexfloating[Any, Any]],]:
    ...
