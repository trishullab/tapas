...
class Extension(old_Extension):
    ...
    """
    def __init__(self, name, sources, include_dirs=..., define_macros=..., undef_macros=..., library_dirs=..., libraries=..., runtime_library_dirs=..., extra_objects=..., extra_compile_args=..., extra_link_args=..., export_symbols=..., swig_opts=..., depends=..., language=..., f2py_options=..., module_dirs=..., extra_c_compile_args=..., extra_cxx_compile_args=..., extra_f77_compile_args=..., extra_f90_compile_args=...) -> None:
        ...
